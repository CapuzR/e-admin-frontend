...
exports.transformOverrideHandler = exports.managementCanisterPrincipal = exports.managementCanisterIdlFactory = void 0;
...
exports.managementCanisterIdlFactory = managementCanisterIdlFactory;
exports.managementCanisterPrincipal = principal_1.Principal.fromHex('');
const transformOverrideHandler = (methodName, args, callConfig) => {
    let overridable = {
        effectiveCanisterId: exports.managementCanisterPrincipal,
    };
    if (!Array.isArray(args) || !args.length)
        return overridable;
    if (args[0].hasOwnProperty('canister_id') && args[0].canister_id) {
        overridable = {
            effectiveCanisterId: principal_1.Principal.from(args[0].canister_id),
        };
    }
    return overridable;
};
exports.transformOverrideHandler = transformOverrideHandler;
