...
export declare const isValidPrincipal: (text: string) => boolean;
export declare const validatePrincipalId: (text: string) => boolean;
export declare const validateAccountId: (text: any) => boolean;
export declare const validateCanisterId: (text: string) => boolean;
export declare const validateToken: (metadata: any) => boolean;
