...
import { WalletConnectRPC, Provider } from '@psychedelic/plug-inpage-provider';
...
var Button = /*#__PURE__*/styled('button', {
  border: 'none',
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              clientRPC = new WalletConnectRPC({
                window: window,
                debug: debug
              });
              plugProvider = new Provider(clientRPC);
              ic = window.ic || {};
...
export { DefaultButtonText };
//# sourceMappingURL=plug-connect.esm.js.map
