...
var plugInpageProvider = require('@psychedelic/plug-inpage-provider');
...
var DefaultButtonText = 'Connect to Plug';

var PlugConnect = function PlugConnect(_ref) {
  var _ref$dark = _ref.dark,
      dark = _ref$dark === void 0 ? false : _ref$dark,
      _ref$title = _ref.title,
      title = _ref$title === void 0 ? DefaultButtonText : _ref$title,
      _ref$whitelist = _ref.whitelist,
      whitelist = _ref$whitelist === void 0 ? [] : _ref$whitelist,
      _ref$timeout = _ref.timeout,
      timeout = _ref$timeout === void 0 ? 120000 : _ref$timeout,
      host = _ref.host,
      onConnectCallback = _ref.onConnectCallback,
      _ref$debug = _ref.debug,
      debug = _ref$debug === void 0 ? true : _ref$debug;

  var handleConnect = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
      var _window$ic, _window, _window$ic2, _window$ic2$plug;

      var clientRPC, plugProvider, ic, connected;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              if ((_window$ic = window.ic) != null && _window$ic.plug) {
                _context.next = 8;
                break;
              }
            ...
            case 4:
              clientRPC = new plugInpageProvider.WalletConnectRPC({
                window: window,
                debug: debug
              });
              plugProvider = new plugInpageProvider.Provider(clientRPC);
              ic = window.ic || {};
              window.ic = _extends({}, ic, {
                plug: plugProvider
              });

            case 8:
              _context.next = 10;
              return (_window = window) == null ? void 0 : (_window$ic2 = _window.ic) == null ? void 0 : (_window$ic2$plug = _window$ic2.plug) == null ? void 0 : _window$ic2$plug.requestConnect({
                whitelist: whitelist,
                host: host,
                timeout: timeout
              });
...
exports.DefaultButtonText = DefaultButtonText;
exports.default = PlugConnect;
//# sourceMappingURL=plug-connect.cjs.development.js.map
