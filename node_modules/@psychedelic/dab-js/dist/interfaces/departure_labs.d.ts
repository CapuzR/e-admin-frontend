...
export declare type Callback = () => Promise<undefined>;
...
export declare type Callback__1 = (arg_0: Message) => Promise<undefined>;
...
export declare type PayloadResult = {
    'Complete': Array<number>;
} | {
    'Chunk': Chunk;
};
export declare type Properties = Array<Property>;
...
export declare type StagedWrite = {
    'Init': {
        'size': bigint;
        'callback': [] | [Callback];
    };
...
export declare type StreamingCallback = (arg_0: StreamingCallbackToken) => Promise<StreamingCallbackResponse>;
...
export declare type TopupCallback = () => Promise<undefined>;
export interface Update {
    'mode': UpdateMode;
    'name': string;
}
export declare type UpdateEventCallback = {
    'Set': Callback__1;
} | {
    'Remove': null;
};
