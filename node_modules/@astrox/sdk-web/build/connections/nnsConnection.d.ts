...
export declare class NNSConnection extends BaseConnection<NNS_SERVICE> {
    ...
    protected constructor(identity: SignIdentity, delegationIdentity: DelegationIdentity, actor?: ActorSubclass<NNS_SERVICE>, agent?: HttpAgent, nnsCanisterId?: string);
    /**
     * create connection
     * @param identity
...
//# sourceMappingURL=nnsConnection.d.ts.map