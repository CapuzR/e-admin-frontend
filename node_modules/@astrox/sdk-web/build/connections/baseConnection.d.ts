...
export declare class BaseConnection<T> implements AbstractConnection<T> {
    ...
    agent?: HttpAgent;
    constructor(identity: SignIdentity, delegationIdentity: DelegationIdentity, canisterId: string, interfaceFactory: InterfaceFactory, actor?: ActorSubclass<T>, agent?: HttpAgent);
