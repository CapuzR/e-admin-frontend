...
export declare class LedgerConnection extends BaseConnection<LEDGER_SERVICE> {
    ...
    agent?: HttpAgent;
    protected constructor(identity: SignIdentity, delegationIdentity: DelegationIdentity, actor?: ActorSubclass<LEDGER_SERVICE>, agent?: HttpAgent, legerCanisterId?: string);
    /**
     * create connection
     * @param identity
...
//# sourceMappingURL=ledgerConnection.d.ts.map