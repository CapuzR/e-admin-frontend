...
class LedgerConnection extends baseConnection_1.BaseConnection {
    ...
    static async createActor(delegationIdentity, ledgerCanisterId, host) {
        const actor = await (0, baseConnection_1._createActor)(ledger_idl_1.default, ledgerCanisterId !== null && ledgerCanisterId !== void 0 ? ledgerCanisterId : constants_1.LEDGER_CANISTER_ID, delegationIdentity, host);
        return actor;
    }
